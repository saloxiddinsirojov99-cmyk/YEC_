...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Profil muvaffaqiyatli olindi.' }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Joriy foydalanuvchi profilini yangilash" }),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiBody)({ type: update_profile_dto_1.UpdateProfileDto }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Profil muvaffaqiyatli yangilandi.' }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Admin statistikasi' }),
    (0, swagger_1.ApiBearerAuth)(),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Foydalanuvchilar ro'yxati (admin)" }),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.ADMIN),
    (0, common_1.Get)(),
