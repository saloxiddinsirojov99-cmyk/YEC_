...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Buyurtma yaratish (customer)' }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Buyurtmalar ro`yxati (admin)' }),
    (0, swagger_1.ApiBearerAuth)(),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Mening buyurtmalarim (customer)" }),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Get)('my'),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Buyurtma statusini yangilash (admin)' }),
    (0, swagger_1.ApiBearerAuth)(),
